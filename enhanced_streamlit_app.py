...
try:
    ...
    st.warning("NLTK data download in progress...")
...
def advanced_summarize(text, num_sentences=3):
    """Advanced extractive summarization using NLTK and NLP techniques"""
    ...
    with col2:
        ...
        if 'summary' in st.session_state:
            ...
            if st.session_state['analysis']:
                st.metric(
                    "Sentiment Score",
                    f"{st.session_state['analysis']['sentiment'].polarity:.2f}"
                )
    ...
    if 'summary' in st.session_state:
        ...
        with col2:
            ...
            if st.session_state['analysis']:
                ...
                st.write(f"**Sentiment Polarity:** {analysis['sentiment'].polarity:.2f}")
                st.write(f"**Sentiment Subjectivity:** {analysis['sentiment'].subjectivity:.2f}")
        ...
        if st.session_state['analysis'] and st.session_state['analysis']['pos_counts']:
...
Sentiment Polarity: {analysis['sentiment'].polarity:.2f}
Sentiment Subjectivity: {analysis['sentiment'].subjectivity:.2f}
...
"""
    ...
    st.markdown(
        ...
        <div style='text-align: center; color: #666; padding: 2rem;'>
            <p>Made with ❤️ using Streamlit, NLTK, TextBlob | Advanced Text Summarizer Pro v2.0</p>
